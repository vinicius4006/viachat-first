  ...
  return (
    <div className='border-gradient flex flex-col items-center p-5 relative'>
      <div className='z-10 flex flex-col items-center'>
        <img className='w-2/12' src={props.plataforma.image}/>
...
function AtendenteCalculoPreco(props) {
  ...
  return (
    <div className='border-gradient flex flex-col items-center rounded-lg p-5'>
      <div className='z-10 flex flex-col items-center'>
        <img className='w-2/12' src='clerk.png'/>
...
function BotCalculoPreco(props) {
  ...
  return (
    <div className='border-gradient flex flex-col items-center p-5'>
      <div className='z-10 flex flex-col items-center'>
        <img className='w-2/12' src='robot.png'/>
...
function PlanoCalculoValor(props) {
  ...
  return (
    <div className={`background-gradient flex flex-col items-center p-5 ${props.className ? props.className : ''}`}>
...
export default function Home() {
  const [plataformas, setPlataformas] = React.useState([
    {nome: 'Quantidade de números de Whatsapp', quantidade: 1, precoPorUnidade: 349.90, image: 'whatsapp2.png'},
    {nome: 'Quantidade de perfis de Instagram', quantidade: 0, precoPorUnidade: 49.90, image: 'instagram2.png'},
    {nome: 'Quantidade de perfis de Facebook', quantidade: 0, precoPorUnidade: 49.90, image: 'messenger2.png'},
    {nome: 'Quantidade de números de Telegram', quantidade: 0, precoPorUnidade: 49.90, image: 'telegram2.png'},
  ]);
    ...
    <div className='overflow-x-hidden overflow-y-hidden'>
      <div className='flex pl-10 pt-6'>
        <div className='flex items-center'>
          ...
          <span className='ml-2'>ViaChat</span>
        </div>
        <div className='flex items-center w-6/12 justify-end'>
          <span className='font-semibold'>Home</span>
          <span className='ml-5 font-semibold'>Services</span>
          <span className='ml-5 font-semibold'>Sobre</span>
          <span className='ml-5 font-semibold'>Contact</span>
          <span className='ml-5 font-semibold'>Log In</span>
          <button className='ml-5 font-semibold gradient-button sign-up__button'>Sign Up</button>
        </div>
      </div>
      <div className='w-full flex relative' style={{height: '700px'}}>
        <div className='pl-40 w-6/12 mt-20 text-justify'>
          <div className='text-7xl font-black tracking-wider'>UI/UX</div>
          <div className='text-7xl font-thin tracking-wider'>DESIGN</div>
          <div className='w-7/12'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent finibus orci enim, eu imperdiet arcu tempor et. Pellentesque metus metus, ornare pulvinar risus et, posuere lacinia nisl.</div>
          <button className='gradient-button learn-more__button'>Learn More</button>
        </div>
        <div className='pt-20 w-6/12 bg-cover bg-top'>
          <img className='z-0 absolute w-7/12 -top-24 -right-40' src='/background1.png'/>
          <img className='z-50 absolute w-4/12 top-20 right-20 pulsate-fwd' src='/celular.png'/>
        </div>
      </div>
